            ...
            {loading && orders.length === 0 ? (
              ...
              <div className="space-y-4">
                {orders.map(order => (
                  <div
                    key={order.id}
                    className={`bg-white border rounded-2xl p-5 shadow-sm transition-all ${selectedOrder?.id === order.id ? 'border-blue-500 ring-2 ring-blue-50/50' : 'border-slate-200 hover:border-slate-300'
                      }`}
                  >
                            ...
                            <div key={item.id} className="border border-slate-100 rounded-xl p-4 bg-slate-50/50">
                              ...
                              <div className="bg-white border border-slate-100 rounded-lg p-3 space-y-2 mt-4">
                                <p className="text-[11px] font-bold text-slate-500 flex items-center gap-1 uppercase tracking-wider">
                                  <Info className="h-3 w-3 text-blue-500" /> Patient Medical Guidelines
                                </p>
                              ...
                              <div className="mt-3 flex justify-end">
                                <button
                                  ...
                                  className="flex items-center gap-1 text-xs font-bold text-blue-600 hover:text-blue-800 bg-white border border-blue-100 hover:bg-blue-50/50 px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
                                >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 space-y-4">
              <h3 className="font-bold text-slate-900 text-lg flex items-center gap-2">
                <Clock className="h-5 w-5 text-blue-600" /> Refill Reminders
              </h3>
              <p className="text-xs text-slate-400">
                    ...
                    <div key={reminder.id} className="flex items-center justify-between border border-slate-100 rounded-xl p-3 bg-slate-50/50">
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 mt-0.5 flex items-center gap-1">
                          ...
                          <span className="font-bold text-blue-600">{new Date(reminder.nextRefillDate).toLocaleDateString('en-IN', {
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-scale-in p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                <Clock className="h-5 w-5 text-blue-600 animate-spin" /> Schedule Refill
              </h3>
            ...
            <form onSubmit={handleCreateReminder} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full border border-slate-200 rounded-xl px-3 py-2.5 outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-800 bg-white"
                >
              ...
              <div className="flex gap-3 pt-3 border-t border-slate-100">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-sm shadow-md transition-colors disabled:opacity-60 flex items-center justify-center gap-1.5"
                >
